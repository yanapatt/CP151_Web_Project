<?php
    ...
    include("Backend/server.php"); // เรียกใช้ไฟล์ที่มีการเชื่อมต่อฐานข้อมูล
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>สมัครใช้งาน MissShop</title>
    <!--Bootstrap 5 CSS CDN-->
    ...
    <section class="container">
        <div class="row">
            <div class="login-register col-12 col-sm-12 col-md-12 col-lg-12">
                <form id="registerFrom" method="POST" action="Backend/register_db.php">
                    <h2>ยินดีต้อนรับผู้ใช้ใหม่</h2>
                    ...
                    <div class="mb-2 form-group">
                        <input type="email" class="en form-control" id="email" placeholder="Email" name="email" required><i class="bi bi-envelope-at-fill"></i>
                    </div>
                    <div class="mb-2 form-group">
                        <input type="password" class="en form-control" id="password_1" placeholder="Password" name="password_1" required><i class="bi bi-key-fill"></i>
                    </div>
                    <div class="mb-2 form-group">
                        <input type="password" class="en form-control" id="password_2" placeholder="Confirm password" name="password_2" required><i class="bi bi-key-fill"></i>
                    </div>
                    <button type="submit" class="btn btn-login mb-2" name="reg_user">สมัครใช้งาน</button>
                    <div class="mb-2">
                        <span class="register">มีบัญชีใช่หรือไม่&#63;<a href="login.php">เข้าสู่ระบบ</a></span>
                    </div>
                </form>
            </div>
        </div>
